import { db, items, categories, sales, saleItems, initializeDatabase } from '../src/lib/server/db/index'
...
const sampleSalesData = [
  { saleDate: new Date('2024-12-01T09:15:00').getTime(), totalAmount: 15.50, paymentMethod: 'cash', customerName: 'John Doe', items: [{ itemCode: 'BEV-001', quantity: 5 }, { itemCode: 'SNK-001', quantity: 3 }, { itemCode: 'SNK-002', quantity: 2 }] },
  { saleDate: new Date('2024-12-01T14:30:00').getTime(), totalAmount: 23.00, paymentMethod: 'mobile_payment', customerName: 'Jane Smith', items: [{ itemCode: 'GRC-001', quantity: 2 }, { itemCode: 'DRY-001', quantity: 3 }, { itemCode: 'DRY-003', quantity: 2 }] },
  { saleDate: new Date('2024-12-02T10:00:00').getTime(), totalAmount: 8.50, paymentMethod: 'cash', customerName: null, items: [{ itemCode: 'BEV-002', quantity: 3 }, { itemCode: 'SNK-003', quantity: 2 }] },
  { saleDate: new Date('2024-12-02T16:45:00').getTime(), totalAmount: 45.00, paymentMethod: 'credit', customerName: 'ABC Company', items: [{ itemCode: 'PRC-001', quantity: 5 }, { itemCode: 'PRC-002', quantity: 5 }, { itemCode: 'PRC-003', quantity: 10 }, { itemCode: 'HHS-001', quantity: 5 }] },
  { saleDate: new Date('2024-12-03T11:20:00').getTime(), totalAmount: 12.80, paymentMethod: 'mobile_payment', customerName: 'Bob Wilson', items: [{ itemCode: 'DRY-002', quantity: 2 }, { itemCode: 'GRC-002', quantity: 3 }, { itemCode: 'SNK-005', quantity: 1 }] },
  { saleDate: new Date('2024-12-03T15:00:00').getTime(), totalAmount: 28.50, paymentMethod: 'cash', customerName: 'Alice Brown', items: [{ itemCode: 'BEV-003', quantity: 4 }, { itemCode: 'BAK-001', quantity: 2 }, { itemCode: 'DRY-004', quantity: 3 }] },
  { saleDate: new Date('2024-12-04T09:30:00').getTime(), totalAmount: 55.00, paymentMethod: 'credit', customerName: 'Tech Solutions Inc', items: [{ itemCode: 'ELE-001', quantity: 5 }, { itemCode: 'ELE-002', quantity: 3 }, { itemCode: 'ELE-003', quantity: 5 }] },
  { saleDate: new Date('2024-12-04T13:15:00').getTime(), totalAmount: 19.75, paymentMethod: 'mobile_payment', customerName: 'Sarah Johnson', items: [{ itemCode: 'GRC-003', quantity: 3 }, { itemCode: 'GRC-004', quantity: 5 }, { itemCode: 'HHS-002', quantity: 3 }] },
  { saleDate: new Date('2024-12-05T10:45:00').getTime(), totalAmount: 7.00, paymentMethod: 'cash', customerName: null, items: [{ itemCode: 'BEV-004', quantity: 5 }, { itemCode: 'SNK-004', quantity: 1 }] },
  { saleDate: new Date('2024-12-05T17:00:00').getTime(), totalAmount: 89.50, paymentMethod: 'credit', customerName: 'Grand Hotel', items: [{ itemCode: 'BEV-001', quantity: 20 }, { itemCode: 'BEV-002', quantity: 30 }, { itemCode: 'BAK-002', quantity: 10 }, { itemCode: 'PRC-005', quantity: 5 }] },
  { saleDate: new Date('2024-12-06T08:30:00').getTime(), totalAmount: 34.20, paymentMethod: 'mobile_payment', customerName: 'Mike Chen', items: [{ itemCode: 'GRC-005', quantity: 4 }, { itemCode: 'GRC-006', quantity: 5 }, { itemCode: 'HHS-004', quantity: 5 }] },
  { saleDate: new Date('2024-12-06T12:00:00').getTime(), totalAmount: 62.00, paymentMethod: 'cash', customerName: 'Restaurant ABC', items: [{ itemCode: 'GRC-007', quantity: 15 }, { itemCode: 'DRY-005', quantity: 8 }, { itemCode: 'HHS-003', quantity: 5 }] },
  { saleDate: new Date('2024-12-07T09:00:00').getTime(), totalAmount: 22.50, paymentMethod: 'mobile_payment', customerName: 'Emily Davis', items: [{ itemCode: 'PRC-004', quantity: 3 }, { itemCode: 'SNK-001', quantity: 5 }, { itemCode: 'BEV-005', quantity: 5 }] },
  { saleDate: new Date('2024-12-07T15:30:00').getTime(), totalAmount: 41.00, paymentMethod: 'credit', customerName: 'Office Supplies Co', items: [{ itemCode: 'HHS-005', quantity: 8 }, { itemCode: 'ELE-004', quantity: 5 }, { itemCode: 'ELE-005', quantity: 2 }] },
  { saleDate: new Date('2024-12-08T11:00:00').getTime(), totalAmount: 15.00, paymentMethod: 'cash', customerName: null, items: [{ itemCode: 'BAK-003', quantity: 2 }, { itemCode: 'BEV-003', quantity: 2 }, { itemCode: 'DRY-001', quantity: 2 }] },
  { saleDate: new Date('2025-01-01T10:00:00').getTime(), totalAmount: 45.00, paymentMethod: 'cash', customerName: 'New Year Customer', items: [{ itemCode: 'BEV-001', quantity: 20 }, { itemCode: 'BEV-002', quantity: 20 }, { itemCode: 'SNK-002', quantity: 10 }] },
  { saleDate: new Date('2025-01-02T14:00:00').getTime(), totalAmount: 125.00, paymentMethod: 'credit', customerName: 'Event Organizers LLC', items: [{ itemCode: 'BEV-003', quantity: 30 }, { itemCode: 'GRC-001', quantity: 10 }, { itemCode: 'PRC-001', quantity: 10 }, { itemCode: 'PRC-002', quantity: 20 }] },
  { saleDate: new Date('2025-01-03T09:30:00').getTime(), totalAmount: 78.50, paymentMethod: 'mobile_payment', customerName: 'Happy Family', items: [{ itemCode: 'DRY-003', quantity: 10 }, { itemCode: 'DRY-002', quantity: 8 }, { itemCode: 'BAK-001', quantity: 10 }, { itemCode: 'HHS-001', quantity: 10 }] },
  { saleDate: new Date('2025-01-04T16:00:00').getTime(), totalAmount: 33.00, paymentMethod: 'cash', customerName: 'Walk-in Customer', items: [{ itemCode: 'SNK-005', quantity: 5 }, { itemCode: 'ELE-003', quantity: 5 }, { itemCode: 'PRC-003', quantity: 10 }] },
  { saleDate: new Date('2025-01-05T11:30:00').getTime(), totalAmount: 210.00, paymentMethod: 'credit', customerName: 'Hotel Paradise', items: [{ itemCode: 'BEV-001', quantity: 100 }, { itemCode: 'BEV-002', quantity: 100 }, { itemCode: 'HHS-002', quantity: 20 }, { itemCode: 'HHS-003', quantity: 20 }] },
  { saleDate: Date.now() - 3600000, totalAmount: 12.50, paymentMethod: 'cash', customerName: 'Morning Shopper', items: [{ itemCode: 'BEV-001', quantity: 5 }, { itemCode: 'SNK-002', quantity: 5 }] },
  { saleDate: Date.now() - 1800000, totalAmount: 28.00, paymentMethod: 'mobile_payment', customerName: 'Lunch Customer', items: [{ itemCode: 'BEV-003', quantity: 4 }, { itemCode: 'BAK-001', quantity: 4 }, { itemCode: 'SNK-001', quantity: 5 }] },
  { saleDate: Date.now() - 900000, totalAmount: 45.50, paymentMethod: 'credit', customerName: 'Afternoon Buyer', items: [{ itemCode: 'GRC-001', quantity: 3 }, { itemCode: 'DRY-003', quantity: 5 }, { itemCode: 'PRC-002', quantity: 5 }] },
  { saleDate: Date.now() - 300000, totalAmount: 8.75, paymentMethod: 'cash', customerName: null, items: [{ itemCode: 'BEV-002', quantity: 3 }, { itemCode: 'SNK-003', quantity: 2 }] }
]
...
async function seedDatabase() {
  try {
    ...
    console.log(`- ${sampleSalesData.length} sales`)
  } catch (error) {
