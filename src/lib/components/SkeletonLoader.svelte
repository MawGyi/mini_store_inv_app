...
{#if type === 'text'}
  <div class="skeleton-text {customClass}" style="width: {width}; height: {height}; {shimmer}"></div>
{:else if type === 'avatar'}
  <div class="skeleton-avatar {customClass}" style="width: {width}; height: {height}; {shimmer}"></div>
{:else if type === 'card'}
  <div class="skeleton-card {customClass}" style="{shimmer}">
...
{:else if type === 'table-row'}
  <div class="skeleton-table-row {customClass}" style="{shimmer}">
    {#each Array(6) as _, i}
